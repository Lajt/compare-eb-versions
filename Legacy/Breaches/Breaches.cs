...
namespace Legacy.Breaches
{
	internal class Breaches : IPlugin, IStartStopEvents, ITickEvents
	{
		...
		public string Name => "Breaches";

		/// <summary>The author of the plugin.</summary>
		public string Author => "Bossland GmbH";

		/// <summary> The description of the plugin. </summary>
		public string Description => "A plugin that makes the bot seek out breaches.";
		...
		public JsonSettings Settings => BreachesSettings.Instance;
