...
namespace Legacy.AutoPassives
{
	internal class AutoPassives : IPlugin, IStartStopEvents, ITickEvents
	{
		...
		public string Name => "AutoPassives";

		/// <summary>The author of the plugin.</summary>
		public string Author => "Bossland GmbH";

		/// <summary> The description of the plugin. </summary>
		public string Description => "A plugin that provides basic auto-passive skill assignment.";
		...
		{
			_taskManager.Reset();
			_taskManager.Add(new AssignPassivesTask());
			_taskManager.Freeze();
		...
		public JsonSettings Settings => AutoPassivesSettings.Instance;
		...
		public void Enable()
		{
			LokiPoe.InGameState.SkillsUi.OnPassiveDump += OnOnPassiveDump;
		}
		...
		private void OnOnPassiveDump(object sender, PassiveDumpEventArgs passiveDumpEventArgs)
		{
			var passive = passiveDumpEventArgs.PassiveSkill;

            Log.InfoFormat("[OnOnPassiveDump] {0}: {1}", passive.Name, passive.PassiveId);
		}
	}
}